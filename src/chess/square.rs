...
/// A square index using the a1 = 0, h8 = 63 convention.
...
impl FromStr for Square {
    ...
    fn from_str(value: &str) -> Result<Self, Self::Err> {
        ...
        {
            return Err("square must use algebraic notation such as e4");
        }
        Self::from_coords(bytes[0] - b'a', bytes[1] - b'1').ok_or("square is out of range")
    }
}
